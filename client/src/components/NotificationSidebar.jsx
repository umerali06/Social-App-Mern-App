            ...
            <li key={notif._id}>
              {notif.type === "message" ? (
                ...
                <Link
                  ...
                  className="block p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                >
                  <div className="text-sm font-semibold text-gray-900 dark:text-white">
                    {notif.sender.name}{" "}
                    <span className="capitalize">{notif.type}</span>ed your post
                  </div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {new Date(notif.createdAt).toLocaleString()}
                  </div>
