              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <motion.div variants={itemVariants} className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="pl-10 py-5 rounded-lg border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:placeholder:text-gray-500 dark:text-white"
                    />
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants}>
                  <Button
                    ...
                    disabled={loading}
                    className={cn(
                      "w-full py-5 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium",
                      loading && "opacity-80"
                    )}
                  >
                    {loading ? (
                ...
                <motion.div variants={itemVariants}>
                  <Link
                    to="/signin"
                    className={cn(
                      "w-full flex items-center justify-center py-5 rounded-lg border border-gray-200 bg-white px-4 text-sm font-medium shadow-sm transition-all hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white"
                    )}
                  >
                    Sign In
                  </Link>
